...
export const config = {
  ...
  STAGES: {
    ...
    declaration_pending: { next: 'video_pending',         deadline_days: 8,    nudge_days: [6],    auto_remove: true,  nudge_email: true,  nudge_sms: true,  notify_champion: false },
    ...
    grant_pending:       { next: 'grant_review',          deadline_days: 11,   nudge_days: [5],    auto_remove: true,  nudge_email: true,  nudge_sms: true,  notify_champion: false },
